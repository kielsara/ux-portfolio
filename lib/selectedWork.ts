...
const selectedWorkItems: SelectedWorkItem[] = [
  ...
  // ── Design System Project ──
  {
    ...
    chartComponents: {
      ...
      previews: [
        {
          title: 'Diverging Column Chart',
          src: '/selected-work/project-two/cards/card-1.png',
          alt: 'Diverging column chart component from the design system',
        ...
        },
        {
          ...
          alt: 'Chart card component from the design system',
          objectPosition: 'center',
          accent: '#e0b85f',
        },
        {
          ...
          alt: 'Table component from the design system',
          objectPosition: 'center',
          accent: '#7da9d8',
        },
        {
          ...
          alt: 'Pie chart component from the design system',
          objectPosition: 'center',
          accent: '#d98e7d',
        },
        {
          title: 'Dual Line Chart - Stacked',
          src: '/selected-work/project-two/cards/card-5.png',
          alt: 'Stacked dual line chart component from the design system',
          objectPosition: 'center',
          accent: '#87b9b6',
        },
        {
          ...
          alt: 'Combination chart component from the design system',
          objectPosition: 'center',
          accent: '#bea5d6',
        },
        {
          title: 'Grouped Bar Chart + Hover Interaction',
          src: '/selected-work/project-two/cards/card-7.png',
          alt: 'Grouped bar chart component with hover interaction from the design system',
          objectPosition: 'center',
          accent: '#5da7b8',
        },
        {
          ...
          alt: 'Error state component from the design system',
          objectPosition: 'center',
          accent: '#b790d4',
        },
        {
          ...
          alt: 'Diverging bar chart component from the design system',
          objectPosition: 'center',
          accent: '#d4b276',
        },
        {
          ...
          alt: 'Area chart component from the design system',
          objectPosition: 'center',
          accent: '#90a97d',
        },
        {
          ...
          alt: 'Bullet chart component from the design system',
          objectPosition: 'center',
          accent: '#cf9c72',
        },
        {
        ...
        },
        {
          ...
          alt: 'Heatmap chart component from the design system',
          objectPosition: 'center',
          accent: '#d39098',
        },
        {
          ...
          alt: 'Scatter plot component from the design system',
          objectPosition: 'center',
          accent: '#c79acb',
        },
        {
        ...
        {
          title: 'Dual Line Chart - Overlapping',
          src: '/selected-work/project-two/cards/card-16.png',
          alt: 'Dual overlapping line chart component from the design system',
          objectPosition: 'center',
        },
        {
          title: 'Bubble Chart',
          src: '/selected-work/project-two/cards/card-17.png',
          alt: 'Bubble chart component from the design system',
          objectPosition: 'center',
        },
        {
          title: 'Line Chart',
          src: '/selected-work/project-two/cards/card-18.png',
